...
public class SpaceController {
   ...
   @RequestMapping(value="mbtilist.sp")
    ...
    public ModelAndView selectStayList(@RequestParam(value = "cpage", defaultValue = "1") int currentPage
    		, @RequestParam(value = "categoryName", defaultValue = "숙박") String categoryName
    		, @RequestParam(value="orderBy", defaultValue = "space_no") String orderBy
 ...
 // 객실에 대한 제한 인원수 조회
    ...
    public ModelAndView spaceInsert(ModelAndView mv, HttpSession session, SpaceAttachment sa, @RequestParam HashMap<String, Object> map,
            ...
            @RequestParam(required = false) ArrayList<Integer> facilityName) throws RestClientException, URISyntaxException {
