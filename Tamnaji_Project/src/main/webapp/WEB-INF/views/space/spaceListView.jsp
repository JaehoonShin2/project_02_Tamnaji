...
<div class="container" style=" padding-top: 170px; margin: 0 auto;">
    ...
    <div class="content-2" id="content">
        ...
        <ul style="display:flex; column-gap: 20px; list-style-type: none; justify-content: right;">
            <li onclick="pageMove(1)">최신순</li>
            <li onclick="pageMove(2)">조회순</li>
            <li onclick="pageMove(3)">찜하기순</li>
            <li onclick="pageMove(4)">평점순</li>
        </ul>
        <script>
            function pageMove(num){
                switch(num){
                    case 1 : location.href = "space.sp?categoryName=${map.categoryName}&orderBy=s.space_no"; break;
                    case 2 : location.href = "space.sp?categoryName=${map.categoryName}&orderBy=s.count"; break;
                    case 3 : location.href = "space.sp?categoryName=${map.categoryName}&orderBy=aaa.likeCount"; break;
                    case 4 : location.href = "space.sp?categoryName=${map.categoryName}&orderBy=bbb.gradeAvg"; break;
                }
            }
        </script>
        <ul class="space-list">
            ...
            <!-- 이 안에 div 로 온클릭 속성 걸지 마세요 -->
                <li class="card" style="width: 260px; height: 450px;">
                    ...
                    <c:otherwise>
                        <c:choose>
                            <c:when test="${empty category}">
                                <a class="pagination-prev"
                                    href="space.sp?cpage=${pi.currentPage-1}&categoryName=${map.categoryName}&minPrice=${map.minPrice}&maxPrice=${map.maxPrice}&checkIn=${map.checkIn}&checkOut=${map.checkOut}&people=${map.people}&orderBy=${map.orderBy}"></a>
                            </c:when>
                            <c:otherwise>
                                <a  class="pagination-prev" 
                        href="space.sp?cpage=${pi.currentPage-1}&categoryName=${map.categoryName}&minPrice=${map.minPrice}&maxPrice=${map.maxPrice}&checkIn=${map.checkIn}&checkOut=${map.checkOut}&category=${map.category}&people=${map.people}&orderBy=${map.orderBy}"></a>
                            </c:otherwise>
                        </c:choose>
                            ...
                            <c:choose>
                                <c:when test="${empty category}">
                                    <a class="pagination-page-number"
                                        href="space.sp?cpage=${p}&categoryName=${map.categoryName}&minPrice=${map.minPrice}&maxPrice=${map.maxPrice}&checkIn=${map.checkIn}&checkOut=${map.checkOut}&people=${map.people}&orderBy=${map.orderBy}">${
                                        p }</a>
                                </c:when>
                                <c:otherwise>
                                    <a class="pagination-page-number"
                                        href="space.sp?cpage=${p}&categoryName=${map.categoryName}&minPrice=${map.minPrice}&maxPrice=${map.maxPrice}&checkIn=${map.checkIn}&checkOut=${map.checkOut}&category=${map.category}&people=${map.people}&orderBy=${map.orderBy}">${
                                        p }</a>
                                </c:otherwise>
                            </c:choose>
                        </c:otherwise>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:choose>
                            <c:when test="${empty category}">
                                <a class="pagination-next"
                                    href="space.sp?cpage=${pi.currentPage+1}&categoryName=${map.categoryName}&minPrice=${map.minPrice}&maxPrice=${map.maxPrice}&checkIn=${map.checkIn}&checkOut=${map.checkOut}&people=${map.people}&orderBy=${map.orderBy}">
                            </c:when>
                            <c:otherwise>
                                <a class="pagination-next"
                                    href="space.sp?cpage=${pi.currentPage+1}&categoryName=${map.categoryName}&minPrice=${map.minPrice}&maxPrice=${map.maxPrice}&checkIn=${map.checkIn}&checkOut=${map.checkOut}&category=${map.category}&people=${map.people}&orderBy=${map.orderBy}">
                            </c:otherwise>
                        </c:choose>
                            <span class="icon-pagination icon-pagination-next">
                                <i class="icon material-icons">keyboard_arrow_left</i>
